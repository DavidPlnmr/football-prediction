...
response = prov.get_matches_in_interval("2016-01-01", "2020-12-31", 491) # Specify a league_id if you want to load a certain league. Careful with a 500 error from the API
