...
\begin{lstlisting}[language=json, firstnumber=1, caption=Aperçu du JSON de l'endpoint Statistics, captionpos=b, label=apercuJSON]
{
    "24562": {
        "statistics": [
        {
...
\begin{table}[htp]
    ...
    open              &                                                      & Ouverture du site                                                                       \\ \hline
    click             &                                                      & Ouverture de la fonctionnalité "Head To Head"                                           \\ \hline
